...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
      <label style="margin-left: 200px">Firma LET</label>
<label style="margin-left: 200px">Firma LGT</label>
<br><br>
<label style="margin-left: 190px">{{$variable->let_st}}</label>
<label style="margin-left: 150px">{{$variable->lgt_st}}</label>
@endforeach
</body>
</html>
